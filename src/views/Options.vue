        ...
        <div class="card">
          <div class="row">
            ...
            <div class="col-xs-12">
              <textarea
                v-model="playerData"
                placeholder="Add save code to import, if exporting your code will appear here"
              ></textarea>
            </div>
            <div class="col-xs-6">
  ...
  methods: {
    confirmReset() {
      this.$modal.show("dialog", {
        title: "Are you sure?",
        text:
          "Please confirm that you want to reset your data, all data will be lost and can only be recovered if you first export a copy of your save data.",
        buttons: [
          {
